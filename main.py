...
class TorquePF6000App(App):
    ...
    def open_config_popup(self):
        ...
        self.cfg_print_mode = Spinner(text=getattr(self, "cfg_print_mode", "USB") if isinstance(getattr(self, "cfg_print_mode", None), str) else "USB", values=["USB", "IP", "SALVAR"])
        ...
        self.cfg_auto_print = CheckBox(active=getattr(self, "cfg_auto_print", True) if isinstance(getattr(self, "cfg_auto_print", True), bool) else True)
